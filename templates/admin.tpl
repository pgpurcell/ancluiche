...
<h4><?php echo $this->title ?> you are now viewing the admin tpl...</h4>
<p>if you have requested it from the ~/admin/index.php i made i think you are authenticated </p> 
<p>let s echo this var : <?php echo $this->exemple ?></p>
